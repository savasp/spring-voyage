...
- [`fast/07-create-start-unit.sh`](../../../tests/e2e/scenarios/fast/07-create-start-unit.sh) — creates a unit and transitions it to `Running` with `spring unit start`, mirroring "Starting the Unit" above.
