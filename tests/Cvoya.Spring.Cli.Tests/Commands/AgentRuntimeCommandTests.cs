...
public class AgentRuntimeCommandTests
{
    ...
    [InlineData("agent-runtime install claude --model claude-sonnet-4-5 --default-model claude-sonnet-4-5")]
    [InlineData("agent-runtime uninstall claude --force")]
    [InlineData("agent-runtime models list claude")]
    [InlineData("agent-runtime models set claude claude-sonnet-4-5,claude-opus-4-1")]
    [InlineData("agent-runtime models add claude claude-opus-4-1")]
